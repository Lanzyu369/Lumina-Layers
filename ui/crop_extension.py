...
.crop-input-group input {{ width: 80px; padding: 8px; border: 1px solid var(--border-color-primary, #ddd); border-radius: 4px; font-size: 14px; background: var(--background-fill-primary, white); color: var(--body-text-color, #333); }}
