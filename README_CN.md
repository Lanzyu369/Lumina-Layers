...
Lumina Studio v1.4.2-cmykw整合三大模块，统一界面：
...
- **多色彩模式**：支持CMYW（青/品红/黄/白）、RYBW（红/黄/蓝/白）与CMYK+W
...
- **支持CMYK+W模式**：White底座 + Cyan/Magenta/Yellow/Black色彩层
- **341色块校准板**：19×18网格，可变层数（0-4层）
- **阶梯高度网格**：每个色块根据序列长度呈现不同高度
- **固定1.0mm白色底座**：类似传统印刷的白纸，为画面提供白色的基底
